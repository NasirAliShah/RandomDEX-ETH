...
contract RandomDEXClaimV1 is ERC20, ERC20Permit, AccessControl, ERC20Fee {
    ...
    constructor(
        ...
        ERC20("RandomDEXClaimV1", "RDXCV1")
        ERC20Permit("RandomDEXClaimV1")
        ERC20Fee(
            defaultAdmin_,
            feeCollector_,
    ...
    function burn(address from, uint256 amount) external onlyRole(BURN_ROLE) {
        require(from != address(0), "RandomDEXClaimV1: invalid sender address");
        require(amount > 0, "RandomDEXClaimV1: invalid token amount");
        _burn(from, amount);
