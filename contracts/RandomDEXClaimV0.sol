...
contract RandomDEXClaimV0 is ERC20, ERC20Permit, AccessControl, ERC20Fee {
    ...
    constructor(
        ...
        ERC20("RandomDEXClaimV0", "RDXCV0")
        ERC20Permit("RandomDEXClaimV0")
        ERC20Fee(
            defaultAdmin_,
            feeCollector_,
    ...
    function burn(address from, uint256 amount) external onlyRole(BURN_ROLE) {
        require(from != address(0), "RandomDEXClaimV0: invalid sender address");
        require(amount > 0, "RandomDEXClaimV0: invalid token amount");
        _burn(from, amount);
