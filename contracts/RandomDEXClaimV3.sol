...
contract RandomDEXClaimV3 is ERC20, ERC20Permit, AccessControl, ERC20Fee {
    ...
    constructor(
        ...
        ERC20("RandomDEXClaimV3", "RDXCV3")
        ERC20Permit("RandomDEXClaimV3")
        ERC20Fee(
            defaultAdmin_,
            feeCollector_,
    ...
    function burn(address from, uint256 amount) external onlyRole(BURN_ROLE) {
        require(from != address(0), "RandomDEXClaimV3: invalid sender address");
        require(amount > 0, "RandomDEXClaimV3: invalid token amount");
        _burn(from, amount);
