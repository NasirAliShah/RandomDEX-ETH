 ...
 */
contract RandomDEXClaimV7 is ERC20, ERC20Permit, AccessControl, ERC20Fee, RandomDEXErrors {
    /**
    ...
    /**
     * @dev The maximum supply of RDX tokens.
     */
     ...
     * @param maxSupply_ Max Supply of RDX TOkens.
    ...
    constructor(
        ...
        ERC20("RandomDEXClaimV7", "RDXCV7")
        ERC20Permit("RandomDEXClaimV7")
        ERC20Fee(
            defaultAdmin_,
            feeCollector_,
        ...
        )
    {
        ...
        if (maxSupply_ == 0) revert InvalidMaxSupplyValue();
