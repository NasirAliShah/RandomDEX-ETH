...
/**
 * @title RandomDEXO
 * @notice An implementation of RandomDEXO token smart contract.
 */
contract RandomDEXO is ERC20, ERC20Permit, AccessControl, ERC20Fee {
    ...
    constructor(
        ...
        ERC20("RandomDEXO", "RDXO")
        ERC20Permit("RandomDEXO")
        ERC20Fee(
            defaultAdmin_,
            feeCollector_,
