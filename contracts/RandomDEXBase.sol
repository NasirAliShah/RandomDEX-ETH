...
/**
 * @title RandomDEXBase
 * @notice An implementation of RandomDEXBase token smart contract.
 */
contract RandomDEXBase is ERC20, ERC20Permit, AccessControl, ERC20Fee {
    ...
    constructor(
        ...
        ERC20("RandomDEXBase", "RDXB")
        ERC20Permit("RandomDEXBase")
        ERC20Fee(
            defaultAdmin_,
            feeCollector_,
