...
contract RandomDEXClaimV4 is ERC20, ERC20Permit, AccessControl, ERC20Fee {
    ...
    constructor(
        ...
        ERC20("RandomDEXClaimV4", "RDXCV4")
        ERC20Permit("RandomDEXClaimV4")
        ERC20Fee(
            defaultAdmin_,
            feeCollector_,
    ...
    function burn(address from, uint256 amount) external onlyRole(BURN_ROLE) {
        require(from != address(0), "RandomDEXClaimV4: invalid sender address");
        require(amount > 0, "RandomDEXClaimV4: invalid token amount");
        _burn(from, amount);
