...
describe("RandomDEXClaimV10 Contract", function () {
  ...
  beforeEach(async function () {
    ...
    // Deploy RandomDEXClaimV10 with mock router
    RandomDEX = await ethers.getContractFactory("RandomDEXClaimV10");
  ...
  describe("Deployment", function () {
    it("Should deploy with correct initial values", async function () {
      expect(await randomDEX.name()).to.equal("RandomDEXClaimV10");
      expect(await randomDEX.symbol()).to.equal("RDXCV10");
