...
async function main() {
  ...
  console.log("Deploying RandomDEXClaimV11 with account:", deployer.address);
  ...
  const RandomDEX = await ethers.getContractFactory("contracts/RandomDEXClaimV11.sol:RandomDEXClaimV11");
  ...
  console.log("RandomDEXClaimV11 deployed to:", randomDEXAddress);
