...
async function main() {
  ...
  console.log("Deploying RandomDEX Base with account:", deployer.address);
  ...
  const RandomDEX = await ethers.getContractFactory("contracts/RandomDEXV5.sol:RandomDEXV5");
  ...
  console.log("RandomDEXV5 deployed to:", randomDEXAddress);
