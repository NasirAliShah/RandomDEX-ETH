...
async function main() {
  ...
  console.log("Deploying RandomDEXV6 with account:", deployer.address);

  // Constructor parameters
  const defaultAdmin = deployer.address;
  const feeCollector = "0x6E236057972C9B0fcD2DaBe64f484812FA8bBD8E"; // Fee collector address
  ...
  const RandomDEX = await ethers.getContractFactory("contracts/RandomDEXV6.sol:RandomDEXV6");
  ...
  console.log("RandomDEXV6 deployed to:", randomDEXAddress);
