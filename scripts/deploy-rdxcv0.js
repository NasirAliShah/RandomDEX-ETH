...
async function main() {
  ...
  console.log("Deploying RandomDEXClaimV0 with account:", deployer.address);
  ...
  const feeMaximumNumerator = 30; // 3% maximum fee
  ...
  const RandomDEX = await ethers.getContractFactory("contracts/RandomDEXClaimV0.sol:RandomDEXClaimV0");
  ...
  console.log("RandomDEXClaimV0 deployed to:", randomDEXAddress);
