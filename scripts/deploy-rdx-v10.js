...
async function main() {
  ...
  console.log("Deploying RandomDEXV10 with account:", deployer.address);
  ...
  const RandomDEX = await ethers.getContractFactory("contracts/RandomDEXV10.sol:RandomDEXV10");
