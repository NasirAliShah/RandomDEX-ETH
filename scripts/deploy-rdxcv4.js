...
async function main() {
  ...
  console.log("Deploying RandomDEXClaimV4 with account:", deployer.address);
  ...
  const RandomDEX = await ethers.getContractFactory("contracts/RandomDEXClaimV4.sol:RandomDEXClaimV4");
  ...
  console.log("RandomDEXClaimV4 deployed to:", randomDEXAddress);
