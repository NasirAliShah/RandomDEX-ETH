...
async function main() {
  ...
  console.log("Deploying RandomDEXClaimV3 with account:", deployer.address);
  ...
  const RandomDEX = await ethers.getContractFactory("contracts/RandomDEXClaimV3.sol:RandomDEXClaimV3");
  ...
  console.log("RandomDEXClaimV3 deployed to:", randomDEXAddress);
