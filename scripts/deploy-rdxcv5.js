...
async function main() {
  ...
  console.log("Deploying RandomDEXClaimV5 with account:", deployer.address);
  ...
  const RandomDEX = await ethers.getContractFactory("contracts/RandomDEXClaimV5.sol:RandomDEXClaimV5");
  ...
  console.log("RandomDEXClaimV5 deployed to:", randomDEXAddress);
