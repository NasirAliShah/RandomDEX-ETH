...
async function main() {
  ...
  console.log("Deploying RandomDEXV7 with account:", deployer.address);
  ...
  const RandomDEX = await ethers.getContractFactory("contracts/RandomDEXV7.sol:RandomDEXV7");
  ...
  console.log("RandomDEXV7 deployed to:", randomDEXAddress);
