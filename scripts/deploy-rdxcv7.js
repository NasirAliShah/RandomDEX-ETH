...
async function main() {
  ...
  console.log("Deploying RandomDEXClaimV7 with account:", deployer.address);
  ...
  const RandomDEX = await ethers.getContractFactory("contracts/RandomDEXClaimV7.sol:RandomDEXClaimV7");
  ...
  console.log("RandomDEXClaimV7 deployed to:", randomDEXAddress);
