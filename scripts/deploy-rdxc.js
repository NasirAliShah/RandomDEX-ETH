...
async function main() {
  ...
  console.log("Deploying RandomDEXClaim with account:", deployer.address);
  ...
  const RandomDEX = await ethers.getContractFactory("contracts/RandomDEXClaim.sol:RandomDEXClaim");
  ...
  console.log("RandomDEXClaim deployed to:", randomDEXAddress);
