...
async function main() {
  ...
  console.log("Deploying RandomDEXClaimV1 with account:", deployer.address);
  ...
  const RandomDEX = await ethers.getContractFactory("contracts/RandomDEXClaimV1.sol:RandomDEXClaimV1");
  ...
  console.log("RandomDEXClaimV1 deployed to:", randomDEXAddress);
