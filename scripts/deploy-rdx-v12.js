...
async function main() {
  ...
  console.log("Deploying RandomDEXV12 with account:", deployer.address);
  ...
  const RandomDEX = await ethers.getContractFactory("contracts/RandomDEXV12.sol:RandomDEXV12");
  ...
  console.log("RandomDEXV12 deployed to:", randomDEXAddress);
