...
async function main() {
  ...
  const RDX_TOKEN = "0x567B593aaE45a5d518D7AAEfa15C80416Cca4bb1";
  const WETH_ADDRESS = "0xfFf9976782d46CC05630D1f6eBAb18b2324d6B14";

  // Contract instances
  const router = await ethers.getContractAt("IUniswapV2Router02", UNISWAP_ROUTER, secondAccount);
  const rdxToken = await ethers.getContractAt("@openzeppelin/contracts/token/ERC20/IERC20.sol:IERC20", RDX_TOKEN, secondAccount);
